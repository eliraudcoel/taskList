...
public class SQLite extends SQLiteOpenHelper {
    ...
    private static final String INSERT_BDD_TASK_1 = "INSERT INTO TASK (CUSTOMER_ID, USER_ID, MACHINE_TYPE, MACHINE_BRAND, PROBLEM, DATE, TERMINATED, TIME_SPEND) VALUES (1, 1, 'télévision', 'SAMSUNG', \"Problème antenne\", '2016-03-31 10:26', 'false', 0 );";
    private static final String INSERT_BDD_TASK_2 = "INSERT INTO TASK (CUSTOMER_ID, USER_ID, MACHINE_TYPE, MACHINE_BRAND, PROBLEM, DATE, TERMINATED, TIME_SPEND) VALUES (1, 1, 'machine à laver', 'BOSH', \"Problème d'entrée d'eau\", '2016-03-30 20:26', 'false', 0 );";
    private static final String INSERT_BDD_TASK_3 = "INSERT INTO TASK (CUSTOMER_ID, USER_ID, MACHINE_TYPE, MACHINE_BRAND, PROBLEM, DATE, TERMINATED, TIME_SPEND) VALUES (1, 1, 'séchoir', 'BOSH', \"Problème chaleur\", '2016-03-30 15:26', 'false', 0 );";
    private static final String INSERT_BDD_TASK_4 = "INSERT INTO TASK (CUSTOMER_ID, USER_ID, MACHINE_TYPE, MACHINE_BRAND, PROBLEM, DATE, TERMINATED, TIME_SPEND) VALUES (1, 1, 'ordinateur', 'ACER', \"Problème d'alimentation\", '2016-03-31 15:26', 'false', 0 );";
    private static final String INSERT_BDD_TASK_5 = "INSERT INTO TASK (CUSTOMER_ID, USER_ID, MACHINE_TYPE, MACHINE_BRAND, PROBLEM, DATE, TERMINATED, TIME_SPEND) VALUES (1, 1, 'ordinateur', 'MSI', \"Problème d'écran\", '2016-04-10 11:00', 'false', 0 );";
    private static final String INSERT_BDD_TASK_6 = "INSERT INTO TASK (CUSTOMER_ID, USER_ID, MACHINE_TYPE, MACHINE_BRAND, PROBLEM, DATE, TERMINATED, TIME_SPEND) VALUES (1, 1, 'téléphone', 'ACER', \"Problème de lumière\", '2016-04-01 18:15', 'false', 0 );";
